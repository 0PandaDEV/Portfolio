<template>
  <div class="navbar">
    <nuxt-link to="/">
      <div class="home icon">
        <svg width="26" height="26" viewBox="0 0 24 24" fill="#303030" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <a target="_blank" href="https://twitter.com/PandaDEV_">
      <div class="twitter icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="#303030" stroke="white"
    ...
    <a target="_blank" href="https://github.com/0PandaDEV/">
      <div class="github icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#303030" stroke="white"
